...
public class ModelItem {
    ...
    public ModelItem(int mHeadImgId, String mName, float mMoney, int mTypeIconId,
    ...
    public static List<ModelItem> getFakeItemsFirst(){
        ...
        for (int i = 0; i < 7; i++) {
            itemsList.add(new ModelItem(headId[i], name[i%3], 20.0f + 2,
