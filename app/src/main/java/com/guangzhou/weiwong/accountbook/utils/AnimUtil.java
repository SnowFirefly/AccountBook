    ...
    public static void animateRevealShow(
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            @Override public void onAnimationEnd(Animator animation) {
                ...
                view.setBackgroundResource(R.drawable.bg_reg);  // test add
...
//                view.setBackgroundResource(android.R.color.transparent);    // test add
            }
        });
    ...
    public static void animateRevealHide(
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            @Override public void onAnimationStart(Animator animation) {
                super.onAnimationStart(animation);
//                view.setBackgroundColor(ContextCompat.getColor(context, color));
                view.setBackgroundResource(R.drawable.bg_reg);
            }
